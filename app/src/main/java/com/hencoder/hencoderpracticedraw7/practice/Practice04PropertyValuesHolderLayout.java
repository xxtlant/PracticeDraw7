    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 第一个： scaleX 从 0 到 1
                PropertyValuesHolder holder1 = PropertyValuesHolder.ofFloat("scaleX", 0,1f);
                // 第二个： scaleY 从 0 到 1
                PropertyValuesHolder holder2 = PropertyValuesHolder.ofFloat("scaleY", 0,1f);
                // 第三个： alpha 从 0 到 1
                PropertyValuesHolder holder3 = PropertyValuesHolder.ofFloat("alpha", 0,1f);
